            ...
            @if (auth()->user()->roles == 'ADMIN')
                <div class="col-auto mr-auto">
                    <a href="#" class="btn btn-sm btn-primary text-white text-decoration-none" data-toggle="modal"
                        data-target="#modal-primary">+ Create New Item</a>
                    <a href="/inventary/export" class="btn btn-sm btn-success text-white text-decoration-none">Export to
                        Excel</a>
                    <button class="btn btn-sm btn-secondary dropdown-toggle" data-bs-toggle="dropdown" aria-haspopup="true"
                            ...
                            <div class="modal-body">
                                <form action="{{ url('/inventaris/update' . $item->id) }}" method="POST">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <label class="small mb-1" for="brand">Brand</label>
                                            <select class="form-control input-group-sm select2" id="brand"
                                                name="brand" required>
                                        ...
                                        <div class="col-md-4">
                                            <label class="small mb-1" for="inventarisCategory_name">Category</label>
                                            <select class="form-control input-group-sm select2"
                                                id="inventarisCategory_name" name="inventarisCategory_name" required>
                                ...
                                <div class="tambahan">
                                    ...
                                    @foreach ($activityEdits as $activity)
                                        @if ($item->id == $activity->inventary_id)
                                            {{ $activity->user->first_name }} edited {{ $activity->field }} from
                                            {{ $activity->old_value }} to {{ $activity->new_value }}
                                            <small
                                                class="text-muted text-gray-500">{{ $activity->created_at->format('l jS, F Y h:i:s A') }}</small>
                                            <br>
                                        @endif
                                    @endforeach
                                </div>
